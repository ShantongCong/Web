    ...
    <script>
        function delContact(contactId) {
            ...
            if (flag) {
                // location.href
                // window.location
                location.href = "del_contact?id=" + contactId;
            }
        }

        function changePageSize(pageSize) {
            location.href = "query_contacts_page?pageSize=" + pageSize;
        }
    </script>
...
<div class="container">
    ...
    <table border="1" class="table table-bordered table-hover">
        <tr>
            <td colspan="8" align="center"><a class="btn btn-primary" href="add1.jsp">添加联系人</a></td>
        </tr>
        <tr class="success">
            <th>编号</th>
            <th>姓名</th>
        ...
        <tr>
            ...
            <td>${contact.email}</td>
            <td>
                <a class="btn btn-default btn-sm" href="update_contact_broker?id=${contact.id}">修改</a>
        ...
        <tr>
            <td colspan="8" align="center" class="form-inline">
                ...
                <a class="btn btn-default ${currentPage == pageNum ? 'btn-success' : ''} " href="query_contacts_page?currentPage=${pageNum}&pageSize=${pageSize}">${pageNum}</a>
                </c:forEach>
