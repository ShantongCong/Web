...
<div class="container" style="width: 400px;">
    ...
    <form action="update_contact" method="post">
        ...
        <div class="form-group">
            ...
            <input id="mobile" type="text" class="form-control" name="mobile" placeholder="请输入手机号码" value="${contact.mobile}"/>
        </div>

        <div class="form-group">
            <label for="email">Email：</label>
            <input id="email" type="text" class="form-control" name="email" placeholder="请输入邮箱地址" value="${contact.email}"/>
        </div>
